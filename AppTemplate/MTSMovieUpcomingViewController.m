//
//  MTSMovieUpcomingViewController.m
//  AppTemplate
//
...
@interface MTSMovieUpcomingViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
...
@implementation MTSMovieUpcomingViewController
...
- (void)requestNewData {
    [[JLTMDbClient sharedAPIInstance] GET:kJLTMDbMovieUpcoming withParameters:@{@"page" : @(_currentPage),
                        @"region" : @"US"
                        }
